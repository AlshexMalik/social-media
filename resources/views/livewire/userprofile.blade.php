<div>
    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 m-2">
            <img class="card-img-bottom"  src="https://upload.wikimedia.org/wikipedia/commons/6/65/No-Image-Placeholder.svg" alt="Card image cap">
        </div>
        <div class="col-md-4 my-auto shadow m-3 p-5">
        ...
        <div class="col-md-4  shadow m-3">
          <div class="row mt-3">                 
            ...
            <div class="jumbotron  bg-danger-subtle">
              <div class="container">
                <h1 class="display-5">{{$like}}</h1>
                <p class="lead">Like</p>
              </div>
            </div>
          </div>
          <div class="col-md-6">
             <div class="jumbotron bg-dark-subtle jumbotron-fluid">
              <div class="container">
                <h1 class="display-5">{{$friendcount}}</h1>
                <p class="lead">Friend</p>
              </div>
            </div>
          
          </div>
        <h3 class=" text-center">Hilights</h3>  
        </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-3 mt-5">
          <h3 class="mt-2">Newest friend</h3>
          ...
          <a class="btn btn-info" href="/myfriend" wire:navigate>See All Friend</a>
        </div>
        <div class="col-md-6 ">
            @foreach ($posts as $post)
              <div class="shadow bg-grey p-3 card m-5">
                <div class="card-body">
